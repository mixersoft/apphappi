    ...
    grunt.extendConfig
      copy:
        www:
          expand:true
          cwd: 'www/'
          src: ['**/*', '!components/**', '!**/*.coffee', '!**/*.scss']
          dest: 'dist/'
        components: 
          expand:true
          cwd: 'www/components/'
          src: ['**/*.js', '**/*.json', '!**/test/**', '!**/*.coffee', '!**/*.scss']
          dest: 'dist/components/'
    console.log "*** MODIFIED *** copy www/components/**/*.js to dist/"
    grunt.task.run "copy:components"
    console.log "*** MODIFIED *** copy www/**/* to dist/ EXCEPT components/, .coffee, .scss"
